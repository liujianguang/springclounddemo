...
import com.gameley.common.LogConfig.parser.ContentParser;
import com.gameley.common.util.ClientUtil;
import com.gameley.common.util.ReflectionUtils;
import com.gameley.entity.Operatelog;
...
public class ModifyAspect {
    ...
    public void doBefore(JoinPoint joinPoint, EnableGameleyLog enableGameleyLog){
        ...
        String handleName=enableGameleyLog.handleName();
        if("".equals(handleName)){
            operateLog.setModifyobject(request.getRequestURL().toString());
        }else {
            operateLog.setModifyobject(handleName);
        }
