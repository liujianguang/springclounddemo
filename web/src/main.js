...
const router = new VueRouter({
  ...
  routes: [
    ...
    },
    {
      path: '/Documents/Doc',
      component: function (resolve) {
        require(['./components/CreateDoc/CreateDoc.vue'], resolve)
      }
    },
    {
      path: '/ThirdWeb/kibana',
      component: function (resolve) {
        require(['./components/ThirdWeb/kibana.vue'], resolve)
      },
    },
    {
      path: '/ThirdWeb/zipkin',
      component: function (resolve) {
        require(['./components/ThirdWeb/zipkin.vue'], resolve)
      },
    },
    {
      path: '/ThirdWeb/springadmin',
      component: function (resolve) {
        require(['./components/ThirdWeb/springadmin.vue'], resolve)
      },
    }
