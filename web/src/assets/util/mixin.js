...
import {
  GET_USER, SET_USER, GET_MSG, SET_MSG, GET_MENUS, SET_MENUS, GET_ALLMENUS, SET_ALLMENUS, GET_CLIENT, GET_TOKEN,
  SET_CLIENT, SET_TOKEN
...
var mixin = {
  ...
  methods:{
    ...mapMutations([
      SET_USER, SET_MENUS, SET_ALLMENUS, SET_CLIENT,SET_TOKEN
    ]),
    setMsg:function(msg){
      if(msg==null){
        return;
    ...
    cancelBox:function () {
      this.$confirm('取消将不保存已填写的信息，确定继续吗？?', '提示', {
