    ...
    <el-table :data="page.items"   border style="width: 100%">
      ...
      <el-input v-model="formData.state" placeholder="请输入审核状态"></el-input>
          ...
          <el-date-picker v-model="formData.dt" type="date" placeholder="选择日期"></el-date-picker>
                    ...
                    <el-form-item label="最后修改人" prop="modifyid">
...
],   modifyid: [
  {
    ...
    trigger: 'blur'
        ...
        dialogFormVisible: false,
                menuId:MENUID.getpageAgDoc,
                deleteUrl:URL+MENUID.deleteAgDoc,
    ...
    created() {
        ...
        methods: {
            formSubmit:function () {
                ...
                if(id===-1){
                    this.$http.post(URL+MENUID.addAgDoc,this.formData).then(function (response){
                    this.query();
                    ...
                    this.$http.post(URL+MENUID.editAgDoc,this.formData).then(function (response) {
